...
public class ModularPlayer : NetworkBehaviour
{
    ...
    public class ModularPlayer_Settings
    {
        ...
        public Rigidbody rb;
        [HideInInspector]
        public ModularPlayer_PlayerInputs ModularplayerInputs;
        [HideInInspector]
        ...
        public bool isOwnerOfObject = false;
    ...
    private void Awake()
    {
        settings.ModularplayerInputs = new ModularPlayer_PlayerInputs();
        settings.networkObject = GetComponent<NetworkObject>();
        settings.playerInputComponent = GetComponent<PlayerInput>();
    ...
    {
        settings.ModularplayerInputs.Enable();
    }
    private void OnDisable()
    {
        settings.ModularplayerInputs.Disable();
    }
    private void Start()
    {
        if (!IsOwner) { cameraMotion.camera.enabled = false; }
    ...
    {
        cameraMotion.input = new Vector2(settings.ModularplayerInputs.ModularPlayer_InputActionMap.LookX.ReadValue<float>(),                                 
            settings.ModularplayerInputs.ModularPlayer_InputActionMap.LookY.ReadValue<float>());
    }
    ...
    public void StartPlayer(Vector3 startPos) 
    {
        ...
        settings.isOwnerOfObject = NetworkManager.LocalClientId == settings.networkObject.OwnerClientId;
    }
